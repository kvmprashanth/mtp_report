...
docker run -d -p 2001:27017 --name m1 --cpuset-cpus="0" --memory="2g" --memory-swap="4g" kvmprashanth/mongodb-enterprise --dbpath /data/db
docker run -d -p 2002:27017 --name m2 --cpuset-cpus="1-2" --memory="4g" --memory-swap="8g" kvmprashanth/mongodb-enterprise --dbpath /data/db

docker run --name r1 --cpuset-cpus="3" --memory="2g" --memory-swap="4g" -p 3001:6379 -d redis
docker run --name r2 --cpuset-cpus="4-5" --memory="4g" --memory-swap="8g" -p 3002:6379 -d redis
