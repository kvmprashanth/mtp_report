...
for var in 7000 6000 5000 4500 4000 3500 3000 2500 2000 1500
do
        echo $var
...
gnome-terminal -x bash -c "sudo -u prashanth sshpass -p 'hondacivic' ssh synerg@10.129.34.7 virsh setmem MTP-1 8G;"
