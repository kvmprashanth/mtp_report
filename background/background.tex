...
type to execute on a system.
     ...
     \begin{figure}
      ...
      \caption{Difference between a VM and Container, Source:\cite{slideshare}}
...
demanding for more memory.
    ...
    \subsubsection{Memory Reclamation without Container support}
...
inside containers in a native container setup and derivative cloud setup. Hence the coming section describes the empirical evaluations to 
do the same.  
